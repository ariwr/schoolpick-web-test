...
export default function TimetableCell({ day, period, blocks, conflicts }: TimetableCellProps) {
    const { setNodeRef, isOver } = useDroppable({
        id: `cell-${day}-${period}`,
        data: { day, period, type: "cell" },
    });
    ...
    return (
        <div
            ref={setNodeRef}
            className={cn(
                "relative h-24 border border-gray-200 rounded-md transition-all duration-200 flex flex-col gap-1 p-1 overflow-y-auto",
