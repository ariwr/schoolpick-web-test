...
def create_location_settings_table():
    """location_settings 테이블 생성"""
    db = SessionLocal()
    try:
        print("=" * 60)
        print("location_settings 테이블 생성")
        print("=" * 60)
        print()
        
        # SQL 파일 읽기
        sql_file_path = os.path.join(os.path.dirname(__file__), 'migrations', 'create_location_settings_table.sql')
        ...
        print("✅ location_settings 테이블이 성공적으로 생성되었습니다.")
        print()
